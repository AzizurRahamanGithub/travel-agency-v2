                            ...
                            >
                                <div className="flex flex-col md:flex-row h-full">
                                    ...
                                    <div className="w-full md:w-2/5 h-64 md:h-auto relative overflow-hidden">
                                        ...
                                        />
                                        <div className="absolute top-4 left-4 bg-white/90 backdrop-blur-sm text-brand-navy text-xs font-bold px-3 py-1.5 rounded-full text-xs font-bold shadow-sm flex items-center gap-1">
                                    ...
                                    <div className="p-8 md:p-10 flex-1 flex flex-col justify-center relative">
                                        {/* Watermark bg */}
                                        <Waves className="absolute right-[-20px] bottom-[-20px] text-gray-50 opacity-50 w-64 h-64 pointer-events-none" />
