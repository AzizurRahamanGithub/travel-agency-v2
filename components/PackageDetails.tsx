...
const PackageDetails: React.FC<PackageDetailsProps> = ({ onNavigateBack }) => {
  ...
  const BookingCardContent = () => (
    <>
        ...
        <div className="flex flex-col gap-3">
            {/* 1. Book This Escape */}
            <button className="w-full py-4 rounded-xl font-bold text-lg shadow-lg flex items-center justify-center gap-2 transition-all duration-300 bg-brand-green text-brand-navy hover:bg-[#8cc72b] hover:scale-[1.02]">
                Book This Escape
            </button>
    ...
    <div className="bg-white min-h-screen pb-20 font-sans">
      ...
      <div className="relative h-auto min-h-[70vh] md:h-[75vh] bg-brand-navy flex flex-col">
        ...
        <div className="absolute inset-0 z-0">
            ...
            />
            <div className="absolute inset-0 bg-gradient-to-t from-brand-navy via-brand-navy/30 to-black/30"></div>
        </div>
        ...
        <div className="relative z-20 container mx-auto px-4 md:px-8 pb-12 mt-auto">
            ...
            >
                ...
                <h1 className="text-4xl md:text-6xl lg:text-7xl font-bold text-white mb-6 tracking-tight leading-none drop-shadow-sm max-w-5xl">
                    Chongqing Cyberpunk<br/><span className="text-transparent bg-clip-text bg-gradient-to-r from-brand-green to-teal-200">Weekend Escape</span>
                </h1>
                  ...
                  <div className="space-y-8">
                      {RAW_ITINERARY.map((day) => (
                          <div key={day.day} className="relative pl-0 md:pl-8">
                              ...
                              {/* Day Badge */}
                              <div className="md:absolute left-[-30px] top-0 w-16 h-8 bg-brand-green text-brand-navy font-bold text-xs rounded-full flex items-center justify-center border-4 border-white shadow-sm hidden md:flex z-10 uppercase tracking-wide">
                                  Day {day.day}
                              </div>
                                                      ...
                                                      return (
                                                          <div key={slot.id} className="relative flex gap-4 md:gap-6 group">
                                                              ...
                                                              <div className="relative flex flex-col items-center">
                                                                  ...
                                                                  {!isLast && <div className="flex-grow w-px bg-gray-100 my-1"></div>}
                                                              </div>
