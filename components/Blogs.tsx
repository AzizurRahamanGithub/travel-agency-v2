    ...
    return (
        <div className="relative w-full">
            <button
                onClick={onToggle}
                disabled={disabled}
                className={`w-full text-left py-3 px-5 pr-10 rounded-full border flex items-center justify-between transition-all bg-gray-50 ${
...
const Blogs: React.FC<BlogsProps> = ({ onNavigate, onBlogClick }) => {
  // --- STATE ---
